...
| Model Name                                                                 | LLM              | [VideoMME (w/o subs)](https://video-mme.github.io/home_page.html#leaderboard) | [VideoVista](https://videovista.github.io/#leaderboard) | [LVbench](https://lvbench.github.io/#leaderboard) | [LongVideoBench (dev)](https://longvideobench.github.io/) | [MLVU (dev)](https://github.com/JUNJIE99/MLVU) | [MVBench](https://huggingface.co/spaces/OpenGVLab/MVBench_Leaderboard) | [MMBench-Video](https://huggingface.co/spaces/opencompass/openvlm_video_leaderboard) | [TempCompass](https://huggingface.co/spaces/lyx97/TempCompass) |
|---------------------------------------------------------------------------|------------------|---------------------|------------|---------|----------------|------|---------|---------------|-------------|
